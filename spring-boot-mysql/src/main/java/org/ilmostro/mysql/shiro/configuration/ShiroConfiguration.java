...
import org.ilmostro.mysql.shiro.filter.JWTFilter;
...
public class ShiroConfiguration {
    ...
    @Bean
    public ShiroFilterFactoryBean shiroFilterFactoryBean(DefaultWebSecurityManager customSecurityManager,
    ...
    @Bean
    public AuthorizationAttributeSourceAdvisor authorizationAttributeSourceAdvisor(DefaultWebSecurityManager customSecurityManager) {
