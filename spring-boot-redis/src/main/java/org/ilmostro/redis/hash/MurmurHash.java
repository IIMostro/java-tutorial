...
public class MurmurHash {
    ...
    public static int hash(Object o) {
        ...
        if (o instanceof Long) {
            return abs(hashLong((Long) o));
        }
        if (o instanceof Integer) {
            return abs(hashLong((Integer) o));
        }
        if (o instanceof Double) {
            return abs(hashLong(Double.doubleToRawLongBits((Double) o)));
        }
        if (o instanceof Float) {
            return abs(hashLong(Float.floatToRawIntBits((Float) o)));
        }
        if (o instanceof String) {
            return abs(hash(((String) o).getBytes()));
        }
        if (o instanceof byte[]) {
            return abs(hash((byte[]) o));
        }
        return abs(hash(o.toString()));
    }
