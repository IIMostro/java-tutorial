...
public class CurrieTest {
  ...
  @Test
  public void simple() {
    Function<Integer, Function<Integer, Function<Integer, Integer>>> currie =
        x -> y -> z -> x + y + z;
  ...
  public static final UidInterface<
          Integer, UserNameInterface<String, AgeInterface<Integer, BuilderInterface<User>>>>
      builder =
          v1 ->
              v2 ->
                  v3 ->
