...
public class ByteBuddyTest {
  ...
  public void create() throws Exception {
    ...
    final Class<? extends ConstructorClass> init =
        new ByteBuddy()
    ...
    final Class<? extends AbstractConstructorClass> loaded =
        new ByteBuddy()
    ...
    final Constructor<? extends AbstractConstructorClass> declaredConstructor =
        loaded.getDeclaredConstructor(String.class);
    declaredConstructor.setAccessible(true);
    final AbstractConstructorClass abstractConstructorClass =
        declaredConstructor.newInstance("hello");
  ...
  public void withName() {
    DynamicType.Unloaded<Object> buddy =
        new ByteBuddy()
            .with(new NamingStrategy.PrefixingRandom("org.ilmostro"))
  ...
  public void classloader() throws Exception {
    ...
    final Class<? extends BizServiceImpl> aClass =
        (Class<? extends BizServiceImpl>) Class.forName(BizServiceImpl.class.getName());
    ...
    final Class<? extends BizServiceImpl> loaded =
        new ByteBuddy()
            .subclass(BizServiceImpl.class)
            .method(ElementMatchers.not(ElementMatchers.isDeclaredBy(Object.class)))
            .intercept(MethodDelegation.to(RunTypeDemo.class))
